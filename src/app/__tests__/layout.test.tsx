...
describe('RootLayout', () => {
    ...
    it('should include all required meta tags', () => {
        ...
        expect(container.querySelector('link[rel="preconnect"][href="https://fonts.googleapis.com"]')).toBeInTheDocument()
        expect(container.querySelector('link[rel="preconnect"][href="https://fonts.gstatic.com"]')).toBeInTheDocument()

        // Check for DNS prefetch
        expect(container.querySelector('link[rel="dns-prefetch"][href="//fonts.googleapis.com"]')).toBeInTheDocument()
        expect(container.querySelector('link[rel="dns-prefetch"][href="//fonts.gstatic.com"]')).toBeInTheDocument()

        // Check for preload
        expect(container.querySelector('link[rel="preload"][href="/favicon.ico"]')).toBeInTheDocument()
        expect(container.querySelector('link[rel="preload"][href="/opengraph-image.png"]')).toBeInTheDocument()
    })
...
describe('Layout Metadata', () => {
    ...
    it('should have correct canonical URL', () => {
        expect(baseMetadata.alternates?.canonical).toBe('https://animeshpandey.com')
    })
