...
export const SITE_CONFIG = {
  ...
  avatarUrl:
    'https://d1iukwsziul56d.cloudfront.net/drupal-local/s3fs-public/2025-08/IMG_3793%202.JPG',
...
export const pageMetadata = {
  ...
  experience: generatePageMetadata({
    title: 'Experience',
    description:
      "Explore Animesh Pandey's professional experience, including roles at leading companies and expertise in PHP, Python, Node.js, React, and web technologies.",
    path: '/experience',
    keywords: [
      'Work Experience',
  ...
  projects: generatePageMetadata({
    title: 'Projects',
    description:
      "Discover Animesh Pandey's portfolio of software projects, showcasing expertise in web development, API design, microservices, and modern technologies.",
    path: '/projects',
    keywords: [
      'Portfolio Projects',
      'Software Projects',
  ...
  skills: generatePageMetadata({
    title: 'Skills',
    description:
      "Comprehensive overview of Animesh Pandey's technical skills including programming languages, frameworks, tools, and technologies.",
    path: '/skills',
    keywords: [
      'Technical Skills',
  ...
  education: generatePageMetadata({
    title: 'Education',
    description:
      'Educational background and qualifications of Animesh Pandey, including academic achievements and professional certifications.',
    path: '/education',
    keywords: [
      'Education',
      'Qualifications',
  ...
  contact: generatePageMetadata({
    title: 'Contact',
    description:
      'Get in touch with Animesh Pandey for collaboration opportunities, project inquiries, or professional networking.',
    path: '/contact',
    keywords: [
      'Contact Information',
      'Get In Touch',
  ...
  blog: generatePageMetadata({
    title: 'Blog',
    description:
      'Explore software engineering insights, tutorials, and technical articles by Animesh Pandey. Covering PHP, Python, Node.js, React, and TypeScript.',
    path: '/blog',
    keywords: [
  ...
  notFound: generatePageMetadata({
    ...
    description:
      "The page you're looking for doesn't exist. Return to the homepage to explore Animesh Pandey's portfolio.",
    path: '/404',
...
export const personStructuredData = {
  ...
  hasOccupation: {
    ...
    description:
      'Backend development specialist with expertise in scalable systems',
  },
};
...
export const portfolioStructuredData = {
  ...
  genre: 'Portfolio',
  keywords:
    'Software Engineering, Web Development, Backend Development, PHP, Python, Node.js, React, TypeScript, Microservices, API Development',
};
...
export const blogStructuredData = {
  ...
  description:
    'Software engineering insights, tutorials, and technical articles',
