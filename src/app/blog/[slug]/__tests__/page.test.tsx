...
describe('generateMetadata', () => {
  ...
  it('should generate correct metadata for blog post', async () => {
    ...
    expect(metadata.alternates?.canonical).toBe(
      `https://animeshpandey.com/blog/${mockPost.slug}`
    );
    expect((metadata.openGraph as any)?.type).toBe('article');
    expect((metadata.openGraph as any)?.publishedTime).toBe(
      mockPost.publishDate
    );
  });
  ...
  describe('generateBlogPostStructuredData', () => {
    ...
    it('should generate correct blog post structured data', () => {
      ...
      expect(structuredData.datePublished).toBe(
        mockStructuredDataPost.publishDate
      );
    ...
    it('should include tags in keywords', () => {
      ...
      expect(structuredData.keywords).toBe(
        mockStructuredDataPost.tags.join(', ')
      );
    });
