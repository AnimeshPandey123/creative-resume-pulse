        ...
        try {
            ...
            const completion = await this.client.chat.completions.create({
                ...
                messages: [
                    {
                        role: 'system',
                        content: 'You are an expert technical writer specializing in software development and programming tutorials. Write clear, engaging, and informative content.'
                    },
                    {
                        role: 'user',
                        content: prompt
...
Tags:`;
            ...
            const completion = await this.client.chat.completions.create({
                ...
                messages: [
                    {
                        role: 'system',
                        content: 'You are a content tagging expert. Return only valid JSON arrays of tag strings.'
                    },
                    {
                        role: 'user',
                        content: prompt
            ...
            try {
                ...
                return Array.isArray(tags) ? tags : ['web-development', 'programming', 'tutorial'];
            } catch {
                return ['web-development', 'programming', 'tutorial'];
            }
        } catch {
...
Excerpt:`;
            ...
            const completion = await this.client.chat.completions.create({
                ...
                messages: [
                    {
                        role: 'system',
                        content: 'You are an expert at writing compelling blog post excerpts. Write concise, engaging descriptions.'
                    },
                    {
                        role: 'user',
                        content: prompt
