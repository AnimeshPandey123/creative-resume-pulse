...
console.log(
  chalk.gray('Content Structure:'),
  blogConfig.contentStructure.join(' → ')
);
...
console.log(
  chalk.gray('Basic:'),
  'npm run generate-blog -- --title "Your Title"'
);
console.log(
  chalk.gray('With Context:'),
  'npm run generate-blog -- --title "Your Title" --context "Your context"'
);
...
console.log(
  chalk.gray('3.'),
  'Run the generator and enjoy AI-powered content!'
);
