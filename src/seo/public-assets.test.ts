  ...
  describe('robots.txt', () => {
    it('exists and includes allowed and sitemap directives', () => {
      ...
      expect(content).toContain(
        'Sitemap: https://animeshpandey.com/sitemap-index.xml'
      );
      expect(content).toContain(
        'Sitemap: https://animeshpandey.com/sitemap.xml'
      );
      expect(content).toContain(
        'Sitemap: https://animeshpandey.com/sitemap-blog.xml'
      );
    });
  ...
  describe('sitemaps', () => {
    it('sitemap-index.xml lists main and blog sitemaps', () => {
      ...
      expect(xml).toContain(
        '<loc>https://animeshpandey.com/sitemap-blog.xml</loc>'
      );
    });
