...
describe('Blog Page Metadata', () => {
    ...
    it('should have correct canonical URL', () => {
        expect(blogMetadata.alternates?.canonical).toBe('https://animeshpandey.com/blog')
    })
...
describe('Blog Page Structured Data', () => {
    it('should contain blog structured data', () => {
        const blogData = blogPageStructuredData.find(data => data['@type'] === 'Blog')
    ...
    it('should contain person structured data', () => {
        const personData = blogPageStructuredData.find(data => data['@type'] === 'Person')
